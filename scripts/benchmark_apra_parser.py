...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Benchmark synthetic APRA XLSX parser layouts. Defaults are sized for a quick "
            "release-hygiene smoke run; pass larger counts for deeper measurements."
        )
    )
