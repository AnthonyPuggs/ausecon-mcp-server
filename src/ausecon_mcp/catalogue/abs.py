...
_RAW_ABS_CATALOGUE = {
    "CPI": {
        ...
        "variants": [
            ...
            {
                "name": "monthly_index",
                "aliases": ["monthly cpi index", "complete monthly cpi index"],
                "abs_key": "1.10001.10.50.M",
                "frequency": "Monthly",
                "frequencies": ["M"],
            },
            {
                "name": "monthly_change",
                "aliases": ["monthly cpi change", "month-ended cpi change"],
                "abs_key": "2.10001.10.50.M",
                "frequency": "Monthly",
                "frequencies": ["M"],
            },
            {
                "name": "monthly_annual_change",
                "aliases": [
                    "monthly inflation",
                    "complete monthly cpi annual change",
                    "year-ended monthly cpi",
                ],
            ...
            {
                "name": "monthly_trimmed_mean",
                "aliases": ["monthly trimmed mean inflation", "monthly trimmed mean cpi"],
                "abs_key": "3.999902.20.50.M",
                "frequency": "Monthly",
                "frequencies": ["M"],
            },
            {
                "name": "monthly_weighted_median",
                "aliases": ["monthly weighted median inflation", "monthly weighted median cpi"],
                "abs_key": "3.999903.20.50.M",
                "frequency": "Monthly",
                "frequencies": ["M"],
            },
    ...
    "LEND_HOUSING": {
        ...
        "variants": [
            {
                "name": "total_housing_lending",
                "aliases": ["new housing lending", "total housing lending"],
                "abs_key": "FIN_VAL.NEWCOMMITS.DV8368.TOTDWELL.TOT.TOT.20.AUS.Q",
                "frequency": "Quarterly",
                "frequencies": ["Q"],
            },
            {
                "name": "owner_occupier",
                "aliases": ["owner-occupier", "owner-occupier housing lending"],
                "abs_key": "FIN_VAL.NEWCOMMITS.DV8368.TOTDWELL.TOT.DV5167.20.AUS.Q",
                "frequency": "Quarterly",
                "frequencies": ["Q"],
            },
            {
                "name": "investor",
                "aliases": ["investment", "investor housing lending"],
                "abs_key": "FIN_VAL.NEWCOMMITS.DV8368.TOTDWELL.TOT.DV5168.20.AUS.Q",
                "frequency": "Quarterly",
                "frequencies": ["Q"],
            },
        ],
