...
`ausecon-mcp-server` is intentionally narrow: official ABS, RBA, and APRA sources, stdio plus
hosted HTTP transport, and small curated semantic and derived layers over source-native retrievals.
